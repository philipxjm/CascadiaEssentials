...
@Mod(cgessentials.MOD_ID)
public class cgessentials
{
    // Directly reference a log4j logger.
    private static final Logger LOGGER = LogManager.getLogger();
    public static final String MOD_ID = "cgessentials";
    ...
    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        ...
        InterModComms.sendTo("ex    ", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
